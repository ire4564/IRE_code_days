...
public class BankC_Menu {
	...
	private void initialize() {
		...
		for(int i = 0; i <= 10; i++) {
			...
			model01.setValueAt("111111-1155544" + (i+1), i, 1);
		...
		for(int i = 0; i <= 10; i++) {
			...
			model3.setValueAt("계좌명"+i+1, i, 0);
			model3.setValueAt("111111-1155544" + (i+1), i, 1);
		...
		for(int i = 0; i <= 10; i++) {
			...
			model.setValueAt("계좌명"+i+1, i, 0);
			model.setValueAt("111111-1155544" + (i+1), i, 1);
